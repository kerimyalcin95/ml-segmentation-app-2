...
- `dataset` contains example data used by the application, including source images, label images, trained models, prediction input images, prediction label images, and label configurations.
